...
// ═══════════════════════════════════════════════════════════════════════════
//                    JoKER_RKS mini - CONFIGURATION
// ═══════════════════════════════════════════════════════════════════════════

// ============================================
// 🔥 JoKER_RKS mini - COMPLETE SETTINGS
// 👑 Developer: AFTAB RKS
...
module.exports = {
    ...
    // ── Channel Settings ──
    CHANNEL_JID: '120363419612386263@newsletter',
    
    CHANNEL_IDS: [
        '120363419612386263@newsletter'
    ],

    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb68jsVDuMRjNEdEwa3b',
     ...
     * @type {string}
     */
    BOT_NAME: process.env.BOT_NAME || '🔥 JoKER_RKS mini 🔥',

    /**
     * @description Owner name
     * @type {string}
     */
    OWNER_NAME: process.env.OWNER_NAME || 'AFTAB RKS',
     ...
     * @type {string}
     */
    BOT_FOOTER: process.env.BOT_FOOTER || '© AFTAB RKS • JoKER_RKS mini',
     ...
     * @type {string}
     */
    CHANNEL_JID: process.env.CHANNEL_JID || '120363419612386263@newsletter',
     ...
     * @type {string}
     */
    CHANNEL_LINK: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029Vb68jsVDuMRjNEdEwa3b',
...
/**
 * @module settings
 * @description JoKER_RKS mini Configuration Module
 * @version 2.0.0
 * @author ᴀʀꜱʟᴀɴ-ᴍᴅ
 * @license MIT
 */
